  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        pickers = {
          find_files = {
            find_command = { 'rg', '--files', '--color', 'never', '--hidden' },
          },
        },
        extensions = {
          ['ui-select'] = {
      ...
      vim.api.nvim_create_user_command('LiveGrepMulti', function()
        -- This calls live_grep and passes '--multiline' to ripgrep
        require('telescope.builtin').live_grep {
          additional_args = { '--multiline' },
        }
      end, { desc = 'Live grep with multiline support' })

      vim.api.nvim_create_user_command('LiveGrepFilesMulti', function()
        require('telescope.builtin').live_grep {
          additional_args = { '--multiline', '-l', '--pcre2' },
        }
      end, { desc = 'Live grep with multiline support for finding files only' })
    end,
  },
